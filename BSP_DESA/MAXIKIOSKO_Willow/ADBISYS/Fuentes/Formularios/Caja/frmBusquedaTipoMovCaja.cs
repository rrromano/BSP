...
{
    public partial class frmBusquedaTipoMovCaja : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                busquedaTipoMovimientos();
            }
        }

        private void busquedaTipoMovimientos()
        {
            try
            {
                ...
                {
                    MessageBox.Show("No se encontraron coincidencias.", "Búsqueda de Tipos de Movimientos.", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cboCampo.Focus();
                    return;
                }
            }
        ...
        private void frmBusquedaTipoMovCaja_Load(object sender, EventArgs e)
        {
            cargarComboCampo();
                ...
                foreach (DataRow dataRow in Ds.Tables[0].Rows)
                {
                    ...
                    switch (dataRow["CAMPO"].ToString())
                    {
                        ...
                        case "MOVIMIENTO":
                            ...
                            break;
                        case "INGRESO/SALIDA":
                            campos_tabla.Add("Ingreso_Salida", (dataRow["CAMPO"].ToString()));
                            break;
                        default:
