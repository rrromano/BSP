...
{
    public partial class frmOrdenarVentas : Form
    {
        ...
        private void frmOrdenarVentas_Load(object sender, EventArgs e)
        {
            cargarComboCampo();
        ...
        private void cargarComboCampo()
        {
            try
            {
                ...
                Entidades.Venta entVentas = new ADBISYS.Entidades.Venta();
                ds = entVentas.obtenerCamposVentas();
